...
export const API_PATHS = {
    ...
    CLASS: {
        ...
        MEMBERS: (classId) => `/api/classes/${classId}/members`,
        APPROVE_MEMBER: (classId, userId) => `/api/classes/${classId}/members/${userId}/approve`,
        DEACTIVATE_MEMBER: (classId, userId) => `/api/classes/${classId}/members/${userId}/deactivate`,
